...
# Load datasets
training <- read.csv("/Users/Akshay/Data/MIT/AML/Project/pml-training.csv", header=TRUE, sep=",",
                     stringsAsFactors=FALSE)
testing  <- read.csv("/Users/Akshay/Data/MIT/AML/Project/pml-testing.csv", header=TRUE, sep=",",
                     stringsAsFactors=FALSE)
...
# Train Models. We use the training_mod3 dataset with relevant feature.
